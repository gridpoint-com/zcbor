...
#define test_str(err) zassert_mem_equal(zcbor_error_str(err), #err, sizeof(#err), NULL)
	...
	test_str(ZCBOR_ERR_STREAM_WRITE_FAILED);
	test_str(ZCBOR_ERR_STREAM_READ_FAILED);
	...
	zassert_mem_equal(zcbor_error_str(ZCBOR_ERR_STREAM_READ_FAILED + 1), "ZCBOR_ERR_UNKNOWN", sizeof("ZCBOR_ERR_UNKNOWN"), NULL);
